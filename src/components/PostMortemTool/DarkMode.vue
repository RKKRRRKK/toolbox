<template>
    <div class="toggleWrapper">
        <input type="checkbox" id="themeSwitch" v-model="isEnabled" @click="enableDark" />
...
function enableDark() {
    ...
    variablesStore.setDarkMode(isEnabled.value)
    console.log("darkmode is: ", isEnabled.value)
}
